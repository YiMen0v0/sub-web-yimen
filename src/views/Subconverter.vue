              ...
              <div v-if="advanced === '2'">
                <el-form-item label="后端地址:">
                  <el-autocomplete style="width: 100%" v-model="form.customBackend" :fetch-suggestions="backendSearch"
                    placeholder="点击即可选择本站后端，也可直接输入你自己的后端地址">
  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "https://sbbk.13792486.best/sub?" }],
        remoteConfig: [
          {
            label: "YIMEN的自用规则",
            options: [
              {
                label: "YIMEN的自用规则",
                value:
                  "https://raw.githubusercontent.com/YiMen0v0/YiMen-SS/refs/heads/rule/Clash/Config/YiMenSS-custom-banAD.ini"
              },
            ]
          },
          {
    ...
    notify() {
      ...
      this.$notify({
        ...
        message: h(
          "i",
          { style: "color: teal" },
          "本站仅生成订阅链接，默认提供后端转换服务，隐私担忧者请自行搭建后端服务。"
        )
      });
    },
    confirmUploadConfig() {
